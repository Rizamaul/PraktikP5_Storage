...
class MahasiswaProvider : ContentProvider() {
    ...
    private val BUKU_DIR = 1

    private val uriMatcher = UriMatcher(UriMatcher.NO_MATCH).apply {
        addURI(AUTHORITY, "buku", BUKU_DIR)
    }
    ...
    override fun query(uri: Uri, projection: Array<String>?, selection: String?,
        ...
        return if (uriMatcher.match(uri) == BUKU_DIR) {
            db.query(DatabaseHelper.TABLE_BUKU, projection, selection, args, null, null, sort)
        } else null
    }

    override fun insert(uri: Uri, v: ContentValues?): Uri? {
        val id = dbHelper.writableDatabase.insert(DatabaseHelper.TABLE_BUKU, null, v)
    ...
    override fun getType(u: Uri) = "vnd.android.cursor.dir/vnd.$AUTHORITY.buku"
}